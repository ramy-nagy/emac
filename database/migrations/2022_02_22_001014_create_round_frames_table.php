...
class CreateRoundFramesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('round_frames', function (Blueprint $table) {
            $table->id();
            ...
            $table->string('bending_distance')->default(0.1);//mm
            $table->softDeletes();
            $table->timestamps();
    ...
    {
        Schema::dropIfExists('round_frames');
    }
}
