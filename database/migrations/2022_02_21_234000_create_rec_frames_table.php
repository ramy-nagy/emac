...
class CreateRecFramesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('rec_frames', function (Blueprint $table) {
            $table->id();
            ...
            $table->string('duct_bending_distance')->default(0.05);//mm
            $table->string('cladding_bending_distance')->default(0.07);//mm
            $table->softDeletes();
            $table->timestamps();
    ...
    {
        Schema::dropIfExists('rec_frames');
    }
}
