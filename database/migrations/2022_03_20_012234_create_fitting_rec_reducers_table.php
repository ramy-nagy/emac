...
class CreateFittingRecReducersTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('fitting_rec_reducers', function (Blueprint $table) {
            $table->id();
            ...
            $table->string('width1')->nulabel();
            $table->string('depth1')->nulabel();
            $table->string('width2')->nulabel();//mm
            $table->string('depth2')->nulabel();//mm
    ...
    {
        Schema::dropIfExists('fitting_rec_reducers');
    }
}
