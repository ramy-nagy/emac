...
class CreateEndCapRecsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('end_cap_recs', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('end_cap_recs');
    }
}
