...
class CreateFittingRecElbowsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('fitting_rec_elbows', function (Blueprint $table) {
            $table->id();
            ...
            $table->string('width')->nulabel();
            $table->string('depth')->nulabel();
            $table->string('length1')->nulabel();//mm
            $table->string('length2')->nulabel();//mm
    ...
    {
        Schema::dropIfExists('fitting_rec_elbows');
    }
}
