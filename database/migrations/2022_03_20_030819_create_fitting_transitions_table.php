...
class CreateFittingTransitionsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('fitting_transitions', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('fitting_transitions');
    }
}
