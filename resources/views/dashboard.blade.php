                            ...
                            <table class="table mb-0 text-left">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="cell">Tag NO</th>
                                        <th class="cell">Description</th>
                                        <th class="cell">location</th>
                                        <th class="cell">section_no</th>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="cell"><span class="truncate">{{$RecDuct->project->name ?? ''}}</span></td>
                                        <td class="cell">{{$RecDuct->tag_no ?? ''}}</td>
                                        <td class="cell">{{$RecDuct->description ?? ''}}</td>
                                        <td class="cell">{{$RecDuct->location ?? ''}}</td>
                                        <td class="cell">{{$RecDuct->section_no ?? ''}}</td>
                                        <td class="cell">{{$RecDuct->created_at ?? ''}}</td>
                                        <td class="cell"><a class="btn-sm app-btn-secondary" href="{{ route('recduct', $RecDuct->id)}}">View</a></td>
                                    </tr>
                                    @empty
