                ...
                <table class="table table-bordered mb-0 text-left">
                    <thead>
                        ...
                        <tr class="dark:border-gray-700 bg-gray-50 dark:text-gray-400 dark:bg-gray-800">
                            ...
                            <td class="cell" colspan="5" class="table-active">Description : {{$RecDuct->description ?? ''}}</td>
                            <td class="cell" colspan="5" class="table-active">location : {{$RecDuct->location ?? ''}}</td>
                            <td class="cell" colspan="5" class="table-active">Section No : {{$RecDuct->section_no ?? ''}}</td>
                        </tr>
