...
<aside class="fixed inset-y-0 z-20 flex-shrink-0 w-64 mt-16 overflow-y-auto dark:bg-gray-800 md:hidden" x-show="isSideMenuOpen"
    ...
    <div class="py-4 text-gray-500 dark:text-gray-400">
        ...
        <ul class="mt-6">
            <li class="relative px-6 py-3">
                <x-nav-link :active="request()->routeIs('dashboard.index')">
                    <x-slot name="icon">
