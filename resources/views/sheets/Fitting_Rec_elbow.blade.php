...
<span class="text-gray-700 dark:text-gray-400">Projects</span>
    <form action="{{route("project.model", 'Fitting_Rec_elbow') }}" method="get" enctype="multipart/form-data">
        @csrf
    ...
    <div class="col-md-12">
        <div class="px-4  py-3 mb-3 text-gray-600 dark:text-gray-300 rounded-lg shadow-md dark:bg-gray-800">
            Project NO :: {{$project_id ?? ''}} - Fitting_Rec_Elbow.
            <form action="{{route('Rec_elbow')}}" method="post">
                @csrf
                ...
                <div class="row mt-3">
                    ...
                    <div class=" col-md-6 border border-dark p-2 my-2 mr-1" style="">
                        ...
                        <label class=" text-sm col-md-2">
                            ...
                            <input type="number" step="0.01" min="0" id="Rec_Elbow_width" value="0"
                                name="width"
                                class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input">
                        </label>
                        <label class=" text-sm col-md-2">
                            <span class="text-gray-700 dark:text-gray-400">Depth (mm)</span>
                            <input type="number" step="0.01" min="0" id="Rec_Elbow_depth" name="depth"
                                value="0"
                                class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input">
                        </label>
                        <label class=" text-sm col-md-2">
                            <span class="text-gray-700 dark:text-gray-400">Length 1 (mm)</span>
                            <input type="number" step="0.01" min="0" id="Rec_Elbow_length1" name="length1"
                                value="0"
                                class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input">
                        </label>
                        <label class=" text-sm col-md-2">
                            <span class="text-gray-700 dark:text-gray-400">Length 2 (mm)</span>
                            <input type="number" step="0.01" min="0" id="Rec_Elbow_length2" name="length2"
                                value="0"
                                class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input">
                        </label>
                ...
                <table class="table whitespace-no-wrap datatable" id="example_1">
                    <thead>
                        <tr
                            ...
                            <th class="py-3">Length1</th>
                            <th class="py-3">Length2</th>
                    ...
                    <tbody class=" divide-y dark:divide-gray-700 dark:bg-gray-800">
                        @forelse ($project->FittingRecElbows as $RecDuct)
                        <tr class="text-gra y-700 dark:text-gray-400">
                            ...
                            <td class="py-3 border border-secondary border-end">{{$RecDuct->length1 ?? ''}}</td>
                            <td class="py-3 border border-secondary border-end">{{$RecDuct->length2 ?? ''}}</td>
                            ...
                            <td>
                                <a href="{{ route('delete',['model'=>'FittingRecElbow', 'id'=> $RecDuct->id]) }}"
    ...
    <script>
        ...
        $("input[type='number']").change(function(){
            var Rec_Elbow_width = parseFloat($("#Rec_Elbow_width").val());
            var Rec_Elbow_depth = parseFloat($("#Rec_Elbow_depth").val());
            var Rec_Elbow_length1 = parseFloat($("#Rec_Elbow_length1").val());
            var Rec_Elbow_length2 = parseFloat($("#Rec_Elbow_length2").val());
            var result = 2*(Rec_Elbow_width+Rec_Elbow_depth)*Rec_Elbow_length1/1000000+2*(Rec_Elbow_width+Rec_Elbow_depth)*Rec_Elbow_length2/1000000
            // area change
        ...
        $('select#Rec_Elbow-Thickness').on('change', function() {
            ...
            var result1 = 2*(Rec_Elbow_width+this.value*4+Rec_Elbow_depth)*Rec_Elbow_length1/1000000+2*(Rec_Elbow_width+Rec_Elbow_depth+this.value*4)*Rec_Elbow_length2/1000000;
            if ( this.value == 25 ) {
